[![Python application test with Github Actions](https://github.com/ChinSekYi/NLP/actions/workflows/main.yml/badge.svg)](https://github.com/ChinSekYi/NLP/actions/workflows/main.yml)
